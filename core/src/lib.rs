...
pub use protocol::{
    data_freq, symbol_len, tone_len, AMPLITUDE, DF, ENCODE_SR, F_DATA0, F_MARKER, GUARD_SAMPLES,
    MAX_PAYLOAD, PREAMBLE_SYMBOLS, SYMBOL_DURATION, SYMBOL_SAMPLES, SYNC_BYTE, TONE_DURATION,
    TONE_SAMPLES, TONE_STEP,
};
